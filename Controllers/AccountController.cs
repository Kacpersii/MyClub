...
namespace MyClub.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, string name, string surname, DateTime birthDate, int phone)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    User userModel = new User { UserName = model.Email, Name = name, Surname = surname, BirthDate = birthDate, Phone = phone };
                    MyClubContext db = new MyClubContext();
